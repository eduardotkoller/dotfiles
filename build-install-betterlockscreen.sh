#!/bin/bash
# sudo apt install -y i3lock libev-dev libxcb-composite0 libxcb-composite0-dev libxcb-xinerama0 libxcb-randr0 libxcb-xinerama0-dev libxcb-xkb-dev libxcb-image0-dev libxcb-util-dev libxkbcommon-x11-dev libjpeg-turbo8-dev libpam0g-dev

# cd /tmp

# # clone the repository
# git clone https://github.com/PandorasFox/i3lock-color i3lock-color
# cd i3lock-color
...
cd `pwd` && make -j8; sudo make install;
